...
const routes: Routes = [
  {
    ...
    children:[
      ...
      { path: 'physical-store', loadChildren: () => import('../../pages/stellar-store/stellar-store.module').then(m => m.StellarStoreModule) },
      { path: 'checkout', loadChildren: () => import('../../pages/checkout/checkout.module').then(m => m.CheckoutModule) },
      { path: 'bag', loadChildren: () => import('../../pages/bag/bag.module').then(m => m.BagModule) },
      { path: 'stellar-store', loadChildren: () => import('./../../pages/physical-store/physical-store.module').then(m => m.PhysicalStoreModule) },
